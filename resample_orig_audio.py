...
if __name__ == "__main__":
    ...
    TIMBRE_SOURCE_DIRECTORY = './Stylus/audios/timbre'
    TIMBRE_TARGET_DIRECTORY = './Stylus/audios/timbre_resampled'
    CONTENT_SOURCE_DIRECTORY = './Stylus/audios/content'
    CONTENT_TARGET_DIRECTORY = './Stylus/audios/content_resampled'
    ...
    # Process timbre files.
    resample_audio_in_subfolders(
        src_dir=TIMBRE_SOURCE_DIRECTORY,
        target_dir=TIMBRE_TARGET_DIRECTORY,
        subfolder_list=TIMBRE_LIST,
        new_sample_rate=TARGET_SAMPLE_RATE
    )

    # Process content files.
    resample_audio_in_subfolders(
        src_dir=CONTENT_SOURCE_DIRECTORY,
        target_dir=CONTENT_TARGET_DIRECTORY,
        subfolder_list=CONTENT_LIST,
        new_sample_rate=TARGET_SAMPLE_RATE
    )
